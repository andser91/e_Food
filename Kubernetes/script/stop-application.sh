...
sudo kubectl delete eployment.apps/iam deployment.apps/consumer-service service/consumer-service deployment.apps/kitchen-service service/kitchen-service deployment.apps/order-service service/order-service deployment.apps/restaurant-service-v1 deployment.apps/restaurant-service-v2 service/restaurant-service
